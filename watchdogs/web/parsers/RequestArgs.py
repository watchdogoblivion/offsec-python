...
class RequestArgs(Args):
  ...
  def addArguments(self):  #type: () -> RequestArgs
    ...
    optional = parser.add_argument_group("Optional request arguments")
    optional.add_argument("-s", "--secure", action="store_true", help=S_HELP)
    optional.add_argument("-pf", "--post-file", help=PF_HELP, type=str, metavar=EMPTY)
    optional.add_argument("-mp", "--multi-part", action="store_true", help=MP_HELP)
    optional.add_argument("-hp", "--http-proxy", help=HP_HELP, type=str, metavar=EMPTY)
    optional.add_argument("-sp", "--https-proxy", help=SP_HELP, type=str, metavar=EMPTY)
    optional.add_argument("-dv", "--disable-verification", action="store_true", help=DV_HELP, default=False)
    optional.add_argument("-rt", "--read-timeout", help=RT_HELP, type=int, metavar=EMPTY, default=None)
    optional.add_argument("-fl", "--filter-length", help=FL_HELP, type=str, metavar=EMPTY, default=EMPTY)
    optional.add_argument("-fs", "--filter-status", help=FS_HELP, type=str, metavar=EMPTY)
    optional.add_argument("-fi", "--filter-in", help=FI_HELP, type=str, metavar=EMPTY)
    optional.add_argument("-fo", "--filter-out", help=FO_HELP, type=str, metavar=EMPTY)
    optional.add_argument("-sr", "--show-response", action="store_true", help=SR_HELP)
